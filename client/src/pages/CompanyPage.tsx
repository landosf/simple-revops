          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <Link href="/book-strategy-call">
                <a>
                  <Button size="lg" className="bg-purple-600 hover:bg-purple-700 text-white border-0" data-testid="button-work-with-us">Work With Us</Button>
                </a>
              </Link>
            </div>
        ...
        <Section>
          <div className="text-center max-w-3xl mx-auto">
            ...
            <Link href="/book-strategy-call#what-youll-get">
              <a>
                <Button size="lg" className="bg-purple-600 hover:bg-purple-700 text-white border-0" data-testid="button-schedule-strategy">How it Works</Button>
              </a>
            </Link>
          </div>
        </Section>
