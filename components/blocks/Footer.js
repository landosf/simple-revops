        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              <li><Link href="/services/infrastructure" className="hover:text-white transition-colors">Revenue Infrastructure</Link></li>
              <li><Link href="/services/analytics" className="hover:text-white transition-colors">Analytics & BI</Link></li>
              <li><Link href="/services/strategy" className="hover:text-white transition-colors">Strategy & GTM</Link></li>
            </ul>
          </div>
