    ...
    <Section>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
        {phases.map((phase, index) => (
          <Card key={index} className={`bg-gradient-to-br ${phase.bgColor} border-t-4 ${phase.borderColor} p-8 rounded-2xl hover:shadow-xl hover:-translate-y-2 transition-all duration-300`}>
      ...
      <div className="bg-gradient-to-r from-blue-50 to-blue-100 rounded-2xl p-10 max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          <div className="bg-white rounded-xl p-6 text-center">
            ...
            <p className="text-sm text-gray-600">Or we work for free until you hit it</p>
          </div>
          <div className="bg-white rounded-xl p-6 text-center">
            <div className="text-4xl font-bold text-green-600 mb-2">90</div>
            <p className="text-gray-700 font-semibold mb-2">Days to Results</p>
            <p className="text-sm text-gray-600">Predictable growth by day 90 or refund</p>
          </div>
        </div>
