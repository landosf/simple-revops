    ...
    <Section background="gradient" className="pt-20">
      <div className="text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
          <Button size="lg" className="bg-red-600 hover:bg-red-700 text-white shadow-lg" data-testid="button-free-audit">
            Get Your Revenue Audit (FREE) →
          </Button>
          <Button variant="secondary" size="lg" className="border-white text-white hover:bg-white hover:text-blue-600" data-testid="button-case-study">
