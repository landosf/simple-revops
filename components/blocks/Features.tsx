...
export default function Features() {
  const features = [
    ...
    },
    {
      ...
      description: "Sales, marketing, product, and customer success work together around shared goals, high-value priorities, and Ideal Customer Profile (ICP) targeting."
    },
    {
