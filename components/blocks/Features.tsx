  ...
  const features = [
    {
      ...
      description: "Get visibility into your revenue performance with a clear data quality framework and focus on metrics that matter."
    },
    {
    ...
    <Section className="bg-gradient-to-br from-purple-50 to-blue-50">
      <div className="text-center mb-16">
        ...
        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          Fix the fundamentals so you can scale with confidence.
        </p>
      </div>
