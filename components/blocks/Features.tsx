...
export default function Features() {
  const features = [
    ...
    },
    {
      ...
      title: "Cross-Team Alignment & Efficient Process",
      description: "Align sales, marketing, product, and customer success around unified goals and high-value priorities."
    },
    {
