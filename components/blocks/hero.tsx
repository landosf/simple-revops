...
export default function Hero() {
  ...
  return (
    <Section
      id="hero"
      className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-blue-600 via-purple-700 to-blue-800"
    >
      {/* Gradient Background */}
      ...
      <Container className="relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          <div className="bg-yellow-400 text-black px-6 py-2 rounded-full inline-block mb-6 font-bold text-lg animate-pulse">
            🔥 Uncover Gaps with a Revenue Audit 🔥
          </div>

          <Heading level={1} className="text-white mb-6 leading-tight">
            Turn revenue chaos into
            <br />
            <span className="text-yellow-300">clarity and scalable growth</span>
          </Heading>

          <p className="text-xl md:text-2xl text-gray-200 mb-10 max-w-4xl mx-auto leading-relaxed">
            <strong>Silos, fragmented funnels, and misaligned efforts </strong>{" "}
            getting in the way of your goals? We've helped SaaS B2B companies
            identify and turn lost revenue into predictable growth.
          </p>
